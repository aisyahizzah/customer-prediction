...
class App extends React.Component {
  ...
  changeCarProb(event) { this.setState({ carprob: event.target.value }); }
  ...
  submit(flag) {
    ...
    console.log('xhttp.responseText:', xmlhttp.responseText);
    console.log('xhttp.status:', xmlhttp.status);

    function reqListener() {
      console.log('this.responseText:', this.responseText);
      console.log('this.status:', this.status);
      var myArr = JSON.parse(this.responseText);
      if (myArr.prediction === 1) {
        Swal.fire(
          'Customer Prediction',
            ...
            <div className="App-form">
              <div className="Form-section">
                <div className="Form-field"><label>
                  Gender :
              <select id="gender" className="field" onChange={this.changeGender.bind(this)} value={this.state.gender}>
                ...
                <div className="Form-field"><label>
                  Education :
              <select id="education" className="field" onChange={this.changeEducation.bind(this)} value={this.state.education}>
                ...
                <div className="Form-field"><label>
                  ...
                  <input id="housevalue" type="range" min="0" max="10000000" class="slider" onChange={this.changeHouseValue.bind(this)} />
                </label></div>
                <div className="Form-field"><label>
                  Age :
              <select id="age" className="field" value={this.state.age} onChange={this.changeAge.bind(this)}>
                ...
                <div className="Form-field"><label>
                  Online Experience :
              <select id="olexp" className="field" onChange={this.changeOlExp.bind(this)} value={this.state.olexp}>
              ...
              <div className="keterangan"> had online shopping experience</div>
                ...
                <div className="Form-field"><label>
                  Customer Psychology :
              <select id="custpsy" className="field" onChange={this.changeCustPsy.bind(this)} value={this.state.custpsy}>
              ...
              <div className="keterangan"> based on area of residence</div>
                ...
                <div className="Form-field"><label>
                  Marriage Status :
              <select id="marriage" className="field" onChange={this.changeMarriage.bind(this)} value={this.state.marriage}>
              ...
              <div className="Form-section">
                <div className="Form-field"><label>
                  Child Status :
              <select id="child" className="field" onChange={this.changeChild.bind(this)} value={this.state.child}>
                    <option value="Y">Y</option>
                    <option value="N">N</option>
                  </select>
                </label></div>
                <div className="Form-field"><label>
                  Occupation :
              <select id="occupation" className="field" onChange={this.changeOccupation.bind(this)} value={this.state.occupation}>
                ...
                <div className="Form-field"><label>
                  Mortgage :
              <select id="mortgage" className="field" onChange={this.changeMortgage.bind(this)} value={this.state.mortgage}>
                ...
                <div className="Form-field"><label>
                  House Owner :
              <select id="houseowner" className="field" onChange={this.changeHouseOwner.bind(this)} value={this.state.houseowner}>
                ...
                <div className="Form-field"><label>
                  Region :
              <select id="region" className="field" onChange={this.changeRegion.bind(this)} value={this.state.region}>
                ...
                <div className="Form-field"><label>
                  Family Income :
              <select id="famincome" className="field" value={this.state.famincome} onChange={this.changeFamIncome.bind(this)}>
                    <option value="A">A</option>
                    <option value="B">B</option>
                    <option value="C">C</option>
                    <option value="D">D</option>
